...
function trocarConteudo(pagina) {
  ...
  switch(pagina) {
    case "sobre":
      conteudoDiv.innerHTML = "Prezados,

Meu nome é Guilherme de Góss, sou estudante de Engenharia de Software e estou em busca de uma oportunidade para iniciar minha carreira na área de tecnologia. Tenho grande interesse em desenvolvimento de software e estou constantemente me dedicando ao aprendizado e aprimoramento de minhas habilidades técnicas.

Ao longo da minha formação, venho construindo uma base sólida em lógica de programação, desenvolvimento e ferramentas importantes da área, além de estar sempre buscando aplicar na prática os conhecimentos adquiridos. Tenho familiaridade com tecnologias como Python, bancos de dados e conceitos de desenvolvimento, e estou em constante evolução para me tornar um profissional cada vez mais preparado.

Sou uma pessoa comprometida, proativa e com facilidade para aprender. Gosto de desafios e acredito que eles são fundamentais para o crescimento profissional. Tenho interesse em colaborar em equipe, contribuir com soluções e evoluir junto com a empresa.
